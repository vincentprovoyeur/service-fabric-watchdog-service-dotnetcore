...
{
    [EventSource(Name = "MyCompany-WatchDogServiceCore-WatchdogService")]
    internal sealed class ServiceEventSource : EventSource
    {
        ...
        [Event(ServiceRequestStopEventId, Level = EventLevel.Error, Message = "Service request '{0}' finished", Keywords = Keywords.Requests)]
        internal void Error(string v1, string v2)
        {
            WriteEvent(ServiceRequestStopEventId,v1 + v2);
        }
        #endregion

...
//            get
//            {
//                //TODO: ServiceEventSource.Current.Trace("HealthState", Enum.GetName(typeof(HealthState), this._healthState));
...
//            catch (TimeoutException ex)
//            {
//                //TODO: ServiceEventSource.Current.Exception(ex.Message, ex.GetType().Name, nameof(this.AddMetricAsync));
//                ServiceEventSource.Current.Message(ex.Message + ex.GetType().Name + nameof(this.AddMetricAsync));
//            }
...
//            catch (TimeoutException ex)
//            {
//                //TODO: ServiceEventSource.Current.Exception(ex.Message, ex.GetType().Name, nameof(this.GetMetricsAsync));
//                ServiceEventSource.Current.Message(ex.Message + ex.GetType().Name + nameof(this.GetMetricsAsync));
//            }
//            catch (FabricTransientException ex)
//            {
//                //TODO: ServiceEventSource.Current.Exception(ex.Message, ex.GetType().Name, nameof(this.GetMetricsAsync));
